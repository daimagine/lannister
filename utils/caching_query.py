...
criteria = criteria.options(FromCache("default"))
criteria = criteria.options(RelationshipCache(Product.customer, "default"))
...
class CachingQuery(Query):
    ...
    def get_value(self, merge=True, createfunc=None,
        ...
        """
        # logger.debug('CachingQuery: get_value')
        dogpile_region, cache_key = self._get_cache_plus_key()

        # logger.debug('CachingQuery: cache_key')
    ...
    def set_value(self, value):
        ...
        # logger.debug('CachingQuery: set_value')
        dogpile_region, cache_key = self._get_cache_plus_key()
